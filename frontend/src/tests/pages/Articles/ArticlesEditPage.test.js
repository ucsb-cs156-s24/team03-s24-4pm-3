...
describe("ArticlesEditPage tests", () => {
    ...
    describe("tests where backend is working normally", () => {
        ...
        test("Is populated with the data provided", async () => {
            ...
            expect(titleField).toHaveValue("test2");
            expect(emailField).toHaveValue("tchoi@ucsb.edu");
            expect(urlField).toHaveValue("test2.com");
            expect(explanationField).toHaveValue("testtesttest2");
        ...
        test("Changes when you click Update", async () => {
            ...
            fireEvent.change(titleField, { target: { value: 'test3' } })
            fireEvent.change(emailField, { target: { value: 'tchoi316@ucsb.edu' } })
            fireEvent.change(urlField, { target: { value: 'test3.com' } })
            fireEvent.change(explanationField, { target: { value: 'testtesttest3' } })
            fireEvent.change(dateAddedField, { target: { value: "2022-12-25T08:00" } })

            fireEvent.click(submitButton);

            await waitFor(() => expect(mockToast).toBeCalled());
            expect(mockToast).toBeCalledWith("Article Updated - id: 17 title: test3");
