...
public class UCSBOrganizationController extends ApiController {
    ...
    @Operation(summary= "Create a new UCSB Org")
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    @PostMapping("/post")
    public UCSBOrganization postUCSBOrganzations(
    ...
    @Operation(summary= "Get one UCSB Organization")
    @PreAuthorize("hasRole('ROLE_USER')")
    @GetMapping("")
    ...
    @Operation(summary= "Update one UCSB Org")
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    @PutMapping("")
    ...
    @Operation(summary= "Delete one UCSBOrganization")
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    @DeleteMapping("")
