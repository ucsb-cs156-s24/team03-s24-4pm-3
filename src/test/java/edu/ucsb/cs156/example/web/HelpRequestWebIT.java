...
public class HelpRequestWebIT extends WebTestCase {
    ...
    public void admin_user_can_create_edit_delete_help_request() throws Exception {
        ...
        page.getByTestId("HelpRequestForm-requesterEmail").fill("ewetzel@ucsb.edu");
        page.getByTestId("HelpRequestForm-teamId").fill("s24-4pm-3");
        page.getByTestId("HelpRequestForm-tableOrBreakoutRoom").fill("table 3");
        page.getByTestId("HelpRequestForm-requestTime").fill("2024-05-07T22:51");
        page.getByTestId("HelpRequestForm-explanation").fill("I lost my glasses");
        page.getByTestId("HelpRequestForm-submit").click();

        assertThat(page.getByTestId("HelpRequestTable-cell-row-0-col-explanation"))
                .hasText("I lost my glasses");

        page.getByTestId("HelpRequestTable-cell-row-0-col-Edit-button").click();
        assertThat(page.getByText("Edit Help Request")).isVisible();
        page.getByTestId("HelpRequestForm-explanation").fill("I found my glasses");
        page.getByTestId("HelpRequestForm-submit").click();

        assertThat(page.getByTestId("HelpRequestTable-cell-row-0-col-explanation")).hasText("I found my glasses");
