...
public class ArticleWebIT extends WebTestCase {
    ...
    public void admin_user_can_create_edit_delete_article() throws Exception {
        ...
        page.getByTestId("ArticleForm-title").fill("Big News");
        page.getByTestId("ArticleForm-url").fill("ww.news.com");
        page.getByTestId("ArticleForm-explanation").fill("Big News Alert");
        page.getByTestId("ArticleForm-email").fill("newsman@gmail.com");
        ...
        page.getByTestId("ArticleForm-explanation").fill("HUGE NEWS");
        page.getByTestId("ArticleForm-submit").click();
