...
public class MenuItemReviewWebIT extends WebTestCase{
    ...
    public void admin_user_can_create_edit_delete_menu_item_review() throws Exception {
        ...
        page.getByTestId("MenuItemReviewForm-itemId").fill("69");
        page.getByTestId("MenuItemReviewForm-dateReviewed").fill("2024-06-02T05:15");
        page.getByTestId("MenuItemReviewForm-reviewerEmail").fill("testemail@gmail.com");
        page.getByTestId("MenuItemReviewForm-stars").fill("5");
        page.getByTestId("MenuItemReviewForm-comment").fill("This is a test comment");
        page.getByTestId("MenuItemReviewForm-submit").click();

        assertThat(page.getByTestId("MenuItemReviewTable-cell-row-0-col-comment"))
        ...
        page.getByTestId("MenuItemReviewForm-comment").fill("yes");
        page.getByTestId("MenuItemReviewForm-submit").click();

        assertThat(page.getByTestId("MenuItemReviewTable-cell-row-0-col-comment")).hasText("yes");
