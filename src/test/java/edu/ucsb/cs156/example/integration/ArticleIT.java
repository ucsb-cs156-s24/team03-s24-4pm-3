...
public class ArticleIT {
    ...
    public void test_that_logged_in_user_can_get_by_id_when_the_id_exists() throws Exception {
        ...
        Articles articles = Articles.builder()
                .id(1L)
                .title("A New Article: Explore Integration Test")
                .url("https://aNewIntegrationTest.articles")
                .explanation("This is a new article for integration test")
    ...
    public void an_admin_user_can_post_a_new_article() throws Exception {
        ...
        Articles articles1 = Articles.builder()
                .id(1L)
                .title("Another Article: Explore Integration Test")
                .url("https://anotherIntegrationTest.articles")
                .explanation("This is another new article for integration test")
        ...
        MvcResult response = mockMvc.perform(
                post("/api/articles/post?title=Another Article: Explore Integration Test&url=https://anotherIntegrationTest.articles&explanation=This is another new article for integration test&email=anotherArticle@gmail.com&dateAdded=2022-04-30T04:00:20")
                        .with(csrf()))
                .andExpect(status().isOk()).andReturn();
