...
public class UCSBOrganizationIT {
    @Autowired
        ...
        public void test_that_logged_in_user_can_get_by_id_when_the_id_exists() throws Exception {
                ...
                // act
                MvcResult response = mockMvc.perform(get("/api/UCSBOrganization?orgCode=KC"))
        ...
        public void an_admin_user_can_post_a_new_organization() throws Exception {
                ...
                MvcResult response = mockMvc.perform(
                                post("/api/UCSBOrganization/post?orgCode=KC&orgTranslationShort=KevinClubShort&orgTranslation=KevinClub&inactive=false")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
